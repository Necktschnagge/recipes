...
Elsa Goletz
\subsubsection{Ursprung}
Halle (Saale) in Sachsen-Anhalt (Deutschland) %bitte prüfen
\subsubsection{Zutaten}
\begin{center}
	\begin{tabular}{|l|rl|}
		\hline
...
\end{enumerate}
\subsubsection{Backzeit}
Im vorgeheizten Herd auf der zweiten Schiene bei 175{\textcelsius} ca. 55 Minuten mit Ober- und Unterhitze backen.
Nach dem Abkühlen kann man nach Belieben Puderzucker aufstäuben.
%\subsubsection{Bilder}
